package de.tud.uw.geo.gi.colabis.workflow;
        ...
        if (request.getContentLength() < Constants.MAX_REQUEST_SIZE) {
            ...
            if (xml != null && xml.length() > 0) {
                ...
                try {
                    ...
                    Transformer transfomer = TransformerFactory.newInstance().newTransformer(new StreamSource(String.valueOf(getClass().getClassLoader().getResource("Graph2Prov.xsl"))));
