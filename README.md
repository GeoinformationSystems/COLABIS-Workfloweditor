...
* ``/web`` - Browser part of the application (Javascript) 
...
* Deploy the web archives (`out/artifacts/Graph2Prov_war`)in a servlet container (e.g. Apache Tomcat)
...
* Bootstrap v4, https://v4-alpha.getbootstrap.com/ - Code licensed under MIT License · Documentation licensed under CC BY 3.0
